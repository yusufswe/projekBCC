...
const Navbar = () => {
  return (
    <div>
      <div className="flex justify-between items-center p-0 gap-[350px] w-full h-[80px] bg-SteelBlue mx-auto px-4 font-semibold fixed z-50">
        ...
        <ul className="md:flex mt-3">
          ...
          <li className="p-3 cursor-pointer">
            <a href="/" className="text-White">Insight</a>
          </li>
          <li className="p-3 cursor-pointer">
