  ...
  return (
    <div>
        ...
        <div className='absolute w-[551px] h-[319px] bg-BlueDark rounded-2xl mt-[250px] ml-[90px]'>
            ...
            {/* <button className='mt-[10px] ml-[455px] absolute font-sans font-bold bg-BlueLight rounded-2xl px-3 py-2 hover:scale-105 duration-400'>Cancel</button> */}
            <button className='mt-[270px] ml-[395px] absolute font-sans font-bold border-2 border-White text-White bg-transparent rounded-2xl px-3 py-2 hover:scale-105 duration-400' onClick={toggleModal}>
              Detail
            </button>
            <button className='mt-[270px] ml-[475px] absolute font-sans font-bold border-2 border-White text-White bg-transparent rounded-2xl px-3 py-2 hover:scale-105 duration-400' onClick={editToggleModal}>
              Edit
            </button>
            {showModal && (
                    ...
                    <div className='flex items-center justify-center min-h-screen'>
                      <div className='bg-BlueDark w-[721px] h-[423px] rounded-lg shadow-lg p-6'>
                        ...
                        <button
                          className='mt-[300px] ml-[600px] font-sans font-bold bg-ChineseBlue rounded-2xl px-3 py-2 hover:scale-105 duration-400'
                          onClick={toggleModal}>
                          Close
                        </button>
                      </div>
            ...
            {editModal && (
              <div className='fixed z-10 inset-0 overflow-y-auto'>
                <div className='flex items-center justify-center min-h-screen'>
                  <div className='bg-BlueDark w-[692px] h-[620px] rounded-lg shadow-lg p-6 mt-[70px] flex justify-center'>
                    ...
                    <button className='absolute text-Black font-bold bg-BlueLight rounded-xl px-5 mt-[510px] mr-[315px] hover:scale-105 duration-400'>Upload</button>
                    <button className='absolute text-Black font-bold w-[410px] bg-BlueLight rounded-xl px-5 mt-[550px]  hover:scale-105 duration-400'>Done</button>
