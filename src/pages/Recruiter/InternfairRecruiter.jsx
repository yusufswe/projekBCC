    ...
    <div>
      <AppLayoutRecruiter>
        ...
        <div className="flex justify-center items-center">
          <img src={bgInternfair} alt="" className="w-full" />
        </div>
            ...
            <div className="fixed z-10 inset-0 overflow-y-auto">
              <div className="flex items-center justify-center min-h-screen">
                <div className="bg-TealBlue w-[349px] h-[395px] rounded-lg shadow-lg p-6">
                  ...
                  <img src={close} alt="" className="absolute cursor-pointer" onClick={toggleModal}/>
...
export default InternfairRecruiter;
