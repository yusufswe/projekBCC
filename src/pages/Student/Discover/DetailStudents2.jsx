      ...
      <AppLayoutStudent>
        ...
        <div className="w-full h-[1200px] bg-BeauBlue">
          <div className="absolute w-[741px] h-[1015px] bg-PaleCerulean rounded-3xl mt-[50px] ml-[130px]">
            ...
            <h2 className="absolute mt-[230px] ml-[40px]">no coding no life</h2>
            ...
            <div>
                <h3 className="absolute font-bold text-xl mt-[540px] ml-[40px]">Fikri Haikal Posts</h3>
...
export default DetailStudents2;
