  ...
  return (
    <div>
        ...
        <div className='absolute w-[551px] h-[319px] bg-BlueDark rounded-2xl mt-[250px] ml-[90px]'>
            ...
            <button className='mt-[190px] ml-[15px] absolute font-sans font-bold bg-Zomp rounded-2xl px-3 py-2 hover:scale-105 duration-400'>Accepted</button>
            <button className='mt-[270px] ml-[435px] absolute font-sans font-bold bg-BlueLight rounded-2xl px-3 py-2 hover:scale-105 duration-400'>Follow up</button>
        </div>
        </div>
    </div>
  )
