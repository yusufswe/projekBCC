  ...
  return (
    <div>
        ...
        <div className='absolute w-[551px] h-[319px] bg-BlueDark rounded-md mt-[250px] ml-[90px]'>
            ...
            <button className='mt-[190px] ml-[15px] absolute font-sans font-bold bg-ChineseBlue rounded-md h-[44px] text-base px-3 py-2 hover:scale-105 duration-400'>Dalam review</button>
        ...
        <div className='absolute w-[551px] h-[319px] bg-BlueDark rounded-md mt-[250px] ml-[690px]'>
            <h3 className='absolute font-sans font-semibold text-White text-2xl mt-[30px] ml-[20px]'>Front End</h3>
